...
# This script was generated Sun Dec  7 11:13:34 2025 by:
#
...
#	/home/ecegridfs/a/559mg81/pvs/svdb/XOR.lvsfile -rcxdir \
#	/home/ecegridfs/a/559mg81/pvs/svdb/XOR -xy_coordinates c,r -type full \
#	-temperature 25.0 -tempdir \
#	/home/ecegridfs/a/559mg81/pvs/svdb/XOR/rcx_temp -sub_node_char # \
#	-res_models yes -parasitic_res_width -parasitic_res_models comment \
#	-parasitic_cap_models no -output_net_name_space schematic \
#	-output_hierarchy_delimiter / -output \
#	/home/ecegridfs/a/559mg81/pvs/svdb/XOR/extview.tmp -net_name_space \
...
#	-hierarchy_delimiter / -hcci_run_name XOR -hcci_run_dir \
...
#	/home/ecegridfs/a/559mg81/pvs/svdb/XOR.gds.map
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/ecegridfs/a/559mg81/pvs/svdb/XOR.gds.map
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/ecegridfs/a/559mg81/pvs/svdb/XOR/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/ecegridfs/a/559mg81/pvs/svdb/XOR
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/ecegridfs/a/559mg81/pvs/svdb/XOR/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/ecegridfs/a/559mg81/pvs/svdb/XOR/XOR.gnx,/home/ecegridfs/a/559mg81/pvs/svdb/XOR/XOR.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/ecegridfs/a/559mg81/pvs/svdb/XOR/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/ecegridfs/a/559mg81/pvs/svdb/XOR
...
agds2rcx -V -H satfile -r /home/ecegridfs/a/559mg81/pvs/svdb/XOR/XOR.xcn \
	...
	XOR.ports -f XOR.alm -lnn XOR.lnn -pnet 5 -pinst 6 -pdev 7 XOR.agf \
	XOR_pin_xy.spi
...
flattenLayers -m cont_0pdiff Via1
flattenLayers -m cont_0ndiff cont_0poly
...
rex -V -m -pd -I'#' -tech \
	...
	-er \
	np_rmetal6_0conn,metal6_conn.den:np_rmetal5_0conn,metal5_conn.den:np_rmetal4_0conn,metal4_conn.den:np_rmetal3_0conn,metal3_conn.den:np_rmetal2_0conn,metal2_conn.den:np_rmetal1_0conn,metal1_conn.den \
	...
	rVia1,2,3,t rVia2,3,4,t rVia3,4,5,t rVia4,5,6,t rVia5,6,7,t \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R metal8_conn -b \
	metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX \
	-t metal9_conn,metal10_conn,metal11_conn -Maxw 1.8 -p \
	metal6_conn:metal6_conn_cut,key,metal8_conn,key 0,1.75,0 - \
	metal6_conn_metal8_conn.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b \
	metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX \
	-t metal8_conn,metal9_conn,metal10_conn,metal11_conn -Maxw 1.8 -p \
	metal6_conn:metal6_conn_cut,key,metal7_conn,key 0,1.75,0 - \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R metal7_conn -b \
	...
	metal5_conn:metal5_conn_cut,key,metal7_conn,key 0,1.75,0 - \
...
sw3d -V -cgnd ${CAP_GROUND} -sub 2 -b \
	...
	metal6_conn:metal6_conn_cut,metal7_conn - \
...
pax16 -V -lee_off -delete_unused_files rm_files_in_pax16 -gnd ${CAP_GROUND} \
	...
	metal6_conn:metal6_conn_cut metal7_conn metal8_conn metal9_conn \
...
xreduce -V -mergecap -n NET -tech \
	...
	metal11_conn,metal10_conn,metal9_conn,metal8_conn,metal7_conn,metal6_conn,metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX,np_rndiff_0conn,np_rpdiff_0conn,np_rnwell_0conn,np_rpsubstrate,rVia1,rVia2,rVia3,rVia4,rVia5,rcont_0poly \
	-decoupled -sr -danglingR -minR 0.001 -rPvia \
	rVia5.res,rVia4.res,rVia3.res,rVia2.res,rVia1.res,rcont_0poly.res,rcont_0pdiff_metal1_0conn_pdiff_0conn.res,rcont_0ndiff_metal1_0conn_ndiff_0conn.res \
	-rP \
	np_rpoly_0conn.res,np_rmetal1_0conn.res,np_rmetal2_0conn.res,np_rmetal3_0conn.res,np_rmetal4_0conn.res,np_rmetal5_0conn.res,np_rmetal6_0conn.res,mwires.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -dxref \
	/home/ecegridfs/a/559mg81/pvs/svdb/XOR/XOR.gdx -nxref \
	/home/ecegridfs/a/559mg81/pvs/svdb/XOR/XOR.gnx -addprefix -sc \
	...
	-rPmw res.mod np_rmetal6_0conn.res,Rnp_rmetal6_0conn.dev2 \
	...
	np_rpoly_0conn.res,Rnp_rpoly_0conn.dev2 rVia5.res,RrVia5.dev2 \
	rVia4.res,RrVia4.dev2 rVia3.res,RrVia3.dev2 rVia2.res,RrVia2.dev2 \
	...
	/home/ecegridfs/a/559mg81/pvs/svdb/XOR/extview.tmp
...
ntap ntap
ENDCAT
cat /home/ecegridfs/a/559mg81/pvs/svdb/XOR/hccisavefile >> _save_layers
