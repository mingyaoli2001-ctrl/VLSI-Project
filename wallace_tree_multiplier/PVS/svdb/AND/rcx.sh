...
# This script was generated Sun Dec  7 11:21:18 2025 by:
#
...
#	/home/ecegridfs/a/559mg81/pvs/svdb/AND.lvsfile -rcxdir \
#	/home/ecegridfs/a/559mg81/pvs/svdb/AND -xy_coordinates c,r -type full \
#	-temperature 25.0 -tempdir \
#	/home/ecegridfs/a/559mg81/pvs/svdb/AND/rcx_temp -sub_node_char # \
...
#	/home/ecegridfs/a/559mg81/pvs/svdb/AND/extview.tmp -net_name_space \
...
#	-hierarchy_delimiter / -hcci_run_name AND -hcci_run_dir \
...
#	/home/ecegridfs/a/559mg81/pvs/svdb/AND.gds.map
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/ecegridfs/a/559mg81/pvs/svdb/AND.gds.map
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/ecegridfs/a/559mg81/pvs/svdb/AND/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/ecegridfs/a/559mg81/pvs/svdb/AND
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/ecegridfs/a/559mg81/pvs/svdb/AND/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/ecegridfs/a/559mg81/pvs/svdb/AND/AND.gnx,/home/ecegridfs/a/559mg81/pvs/svdb/AND/AND.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/ecegridfs/a/559mg81/pvs/svdb/AND/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/ecegridfs/a/559mg81/pvs/svdb/AND
...
agds2rcx -V -H satfile -r /home/ecegridfs/a/559mg81/pvs/svdb/AND/AND.xcn \
	...
	AND.ports -f AND.alm -lnn AND.lnn -pnet 5 -pinst 6 -pdev 7 AND.agf \
	AND_pin_xy.spi
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -dxref \
	/home/ecegridfs/a/559mg81/pvs/svdb/AND/AND.gdx -nxref \
	/home/ecegridfs/a/559mg81/pvs/svdb/AND/AND.gnx -addprefix -sc \
	...
	/home/ecegridfs/a/559mg81/pvs/svdb/AND/extview.tmp
...
ntap ntap
ENDCAT
cat /home/ecegridfs/a/559mg81/pvs/svdb/AND/hccisavefile >> _save_layers
